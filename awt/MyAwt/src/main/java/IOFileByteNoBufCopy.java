...
public class IOFileByteNoBufCopy {
        public static void main(String[] args) {
            String inFileStr = "IOFileByteIn.jpg";   // default path is the root of the project D:\java\awt\MyAwt
            ...
            System.out.println("File size is " + fileIn.length() + " bytes, now copying...");
