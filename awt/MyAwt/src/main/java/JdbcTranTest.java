...
public class JdbcTranTest {    // Save as "JdbcTranTest.java"
    public static void main(String[] args) {
        try (
            ...
            String strUpdate = "update user set name = \"name10\"  where id = 10;";
            System.out.println("The SQL statement is: " + strUpdate + "\n");  // Echo for debugging
            int countUpdated = stmt.executeUpdate(strUpdate);
            System.out.println(countUpdated + " records affected.\n");

              strUpdate = "update user set name = \"name11\"  where id = 15;";
            System.out.println("The SQL statement is: " + strUpdate + "\n");  // Echo for debugging
